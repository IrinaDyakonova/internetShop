...
public class AuthorizationFilter implements Filter {
    ...
    public void init(FilterConfig filterConfig) throws ServletException {
        protectedUrls.put("/users/list", Set.of(Role.RoleName.ADMIN));
        protectedUrls.put("/admin/products/list", Set.of(Role.RoleName.ADMIN));
        protectedUrls.put("/products/fill", Set.of(Role.RoleName.ADMIN));
        protectedUrls.put("/admin/orders/list", Set.of(Role.RoleName.ADMIN));
        protectedUrls.put("/shopping-carts/show", Set.of(Role.RoleName.USER));
        protectedUrls.put("/orders/complete", Set.of(Role.RoleName.USER));
        protectedUrls.put("/orders/personal/list", Set.of(Role.RoleName.USER));
        protectedUrls.put("/products/list", Set.of(Role.RoleName.USER));
    }
